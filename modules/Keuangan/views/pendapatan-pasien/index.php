<?php
    ...
    $this->title = 'Laporan Pendapatan Pasien';
    ...
    $resetUrl = \yii\helpers\Url::to(['pendapatan-pasien/index']);
?>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-block d-md-flex">
                <h2 class="mb-0">Laporan Pendapatan Pasien</h2>
            </div>
            <div class="d-md-flex row m-0 quick-action-btns">
                <?= Html::beginForm(['/keuangan/pendapatan-pasien/index'], 'get') ?>
                    ...
                    <div class="table-responsive">
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    'attribute' => 'dokter_asal',
                                    'label' => 'Dokter Asal',
                                    'value' => function ($model) {
                                        $gelar = isset($model['gelardepan_asal']) ? $model['gelardepan_asal'] . " " : '';
                                        $gabung = $gelar . $model['nama_pegawai_asal'];
                                        return $gabung;
                                    }
                                ],
                                [
                                ...
                                [
                                    'attribute' => 'dokter_akhir',
                                    'label' => 'Dokter Akhir',
                                    'value' => function ($model) {

                                        if (isset($model['nama_pegawai_akhir'])) {
                                            $gelar = isset($model['gelardepan_akhir']) ? $model['gelardepan_akhir'] . " " : '';
                                            $gabung = $gelar . $model['nama_pegawai_akhir'];
                                        } else {
                                            $gelar = isset($model['gelardepan_asal']) ? $model['gelardepan_asal'] . " " : '';
                                            $gabung = $gelar . $model['nama_pegawai_asal'];
                                        }
...
<?php
$urlExport = \yii\helpers\Url::to(['pendapatan-pasien/export']);
