<?php
    ...
    $resetUrl = \yii\helpers\Url::to(['neraca-saldo/index']);
?>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-block d-md-flex">
                <h2 class="mb-0">Laporan Neraca Saldo</h2>
            </div>
            <div class="d-md-flex row m-0 quick-action-btns">
                <?= Html::beginForm(['/keuangan/neraca-saldo/index'], 'get', ['id' => 'neraca-saldo-form']) ?>
                    ...
                    <div class="table-responsive">
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    'attribute' => 'saldo_debit',
                                    'label' => 'Debit',
                                    'value' => function ($model) {
                                        return isset($model['saldo_debit']) ? number_format($model['saldo_debit'], 2, ',', '.') : '';
                                    }
                                ],
                                [
                                    ...
                                    'label' => 'Kredit',
                                    'value' => function ($model) {
                                        return isset($model['saldo_kredit']) ? number_format($model['saldo_kredit'], 2, ',', '.') : '';
                                    }
                                ],
                            ],
                            'layout' => "{items}\n<div class='row'>
...
<?php
$urlExport = \yii\helpers\Url::to(['neraca-saldo/export']);

$js = <<<JS
    
    document.getElementById('neraca-saldo-form').addEventListener('submit', function(e) {
    ...
    $('#export-button').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                a.href = url;
                a.download = 'laporan-neraca-saldo.xlsx';
