...
class ResponsetimePasienPerPoliDokterController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Respontime Pasien Eksekutif Per Poli Dokter');
        ...
        $fileName = 'lap-respon-time-pasien-poli-dokter.xlsx';
    ...
    public function baseQuery()
    {
        $query =  "
            WITH data_pasien AS (
                ...
                JOIN pegawai_m pm ON pm.pegawai_id = pp.pegawai_id
                ...
                GROUP BY t.pendaftaran_id, pp.pegawai_id, pm.nama_pegawai, pm.gelardepan, pp.ruangan_id, rm.ruangan_nama
            ),
            ...
            avg_detik AS (
                ...
                WHERE 
                    ...
                    t6 IS NOT NULL AND 
                    t7 IS NOT NULL
                GROUP BY pegawai_id, nama_pegawai, gelardepan, ruangan_id, ruangan_nama
            )
