...
class ResponsetimePasienPerDokterController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Respontime Pasien Eksekutif Per Dokter');
        ...
        foreach ($models as $model) {
            ...
            $sheet->setCellValue('F' . $row, $model['gelardepan'] . ' ' . $model['nama_pegawai']);
        ...
        $fileName = 'lap-respon-time-pasien-dokter.xlsx';
    ...
    public function baseQuery()
    {
        $query =  "
            WITH data_pasien AS (
                ...
                JOIN pegawai_m rm ON rm.pegawai_id = pp.pegawai_id

                WHERE 
                pp.tgl_pendaftaran::date BETWEEN :datefrom and :dateto 
                AND pp.pasienbatalperiksa_id IS NULL

                GROUP BY t.pendaftaran_id, pp.pegawai_id, rm.nama_pegawai, rm.gelardepan
            ),
            ...
            avg_detik AS (
                ...
                GROUP BY pegawai_id, nama_pegawai, gelardepan
            )
