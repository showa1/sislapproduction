...
class ResponsetimePasienController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Respontime Pasien Eksekutif Summary');
        ...
        $fileName = 'lap-respon-time-pasien-eksekutif-summary.xlsx';
