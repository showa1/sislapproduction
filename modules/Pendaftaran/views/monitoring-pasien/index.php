...
$this->title = 'Monitoring Pasien Pendaftaran';
$this->params['breadcrumbs'][] = ['label' => 'Pendaftaran', 'url' => ['/pendaftaran/dashboard/index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="pendaftaran-monitoring-pasien">
    <?php Pjax::begin(['id' => 'pjax-grid-monitoring', 'timeout' => false]); ?>
        ...
        <div class="card-body px-4 py-3">
            <?= Html::beginForm(['index'], 'get', ['id' => 'filterForm', 'data-pjax' => '1']) ?>
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4">
                        <label class="form-label text-muted small fw-bold">Pencarian (No. RM / Nama Pasien / No. Daftar)</label>
