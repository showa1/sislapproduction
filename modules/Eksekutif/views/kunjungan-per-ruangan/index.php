<?php
    ...
    $this->title = 'Laporan Kunjungan Per Ruangan';
    ...
    $resetUrl = \yii\helpers\Url::to(['kunjungan-per-ruangan/index']);
?>

<div class="row quick-action-toolbar">
    <div class="col-md-12">
        <h2 style="color: #002D72; font-weight: bold; margin-bottom: 20px;">Laporan Kunjungan Per Ruangan</h2>
        <div class="card border-0 shadow-sm p-3">
            <div class="d-md-flex row m-0 quick-action-btns">
                <?= Html::beginForm(['/eksekutif/kunjungan-per-ruangan/index'], 'get') ?>
...
<?php
$urlExport = \yii\helpers\Url::to(['kunjungan-per-ruangan/export']);
