<?php
    ...
    $this->title = 'Laporan Jumlah Kunjungan Rawat Inap Berdasarkan Cara Bayar';
    ...
    $resetUrl = \yii\helpers\Url::to(['kunjungan-inap-bayar/index']);
?>

<div class="row quick-action-toolbar">
    <div class="col-md-12">
        <h2 style="color: #002D72; font-weight: bold; margin-bottom: 20px;">Laporan Jumlah Kunjungan Rawat Inap Berdasarkan Cara Bayar</h2>
        <div class="card border-0 shadow-sm p-3">
            <div class="d-md-flex row m-0 quick-action-btns">
                <?= Html::beginForm(['/eksekutif/kunjungan-inap-bayar/index'], 'get') ?>
...
<?php
$urlExport = \yii\helpers\Url::to(['kunjungan-inap-bayar/export']);
