<?php
    ...
    $this->title = 'Laporan Jumlah Kunjungan Rawat Inap Berdasarkan Asal Pasien dan Cara Bayar';
    ...
    $resetUrl = \yii\helpers\Url::to(['inap-pasien-bayar/index']);
?>

<div class="row quick-action-toolbar">
    <div class="col-md-12">
        <h2 style="color: #002D72; font-weight: bold; margin-bottom: 20px;">Laporan Jumlah Kunjungan Rawat Inap Berdasarkan Asal Pasien dan Cara Bayar</h2>
        <div class="card border-0 shadow-sm p-3">
            <div class="d-md-flex row m-0 quick-action-btns">
                <?= Html::beginForm(['/eksekutif/inap-pasien-bayar/index'], 'get') ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 p-5">
                        <label class="form-label mb-4 fs-5">Instalasi</label>
                        <div class="row dropdown">
                            <?php echo Html::dropDownList('instalasi', $dropdownselect['instalasi'], $listinstalasi, [
                    ...
                    <div class="table-responsive">
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    'attribute' => 'instalasi_asal',
                                    'label' => 'Instalasi Asal'
                                ],
                                [
                                    'attribute' => 'instalasi_bayar',
                                    'label' => 'Instalasi Bayar'
                                ],
                                [
...
<?php
$urlExport = \yii\helpers\Url::to(['inap-pasien-bayar/export']);
...
$js = <<<JS
    ...
    $('#export-button').on('click', function() {
        ...
        let instalasi = document.getElementsByName("instalasi")[0].value;
        window.location.href = "$urlExport" + "&date_from=" + date_from + "&date_to=" + date_to +"&cari=aktif" + "&instalasi=" + instalasi;
    });
JS;
$this->registerJs($js);
?>
