<?php
    ...
    $this->title = 'Laporan Jumlah Kunjungan Berdasarkan Asal Masuk Pasien';
    ...
    $resetUrl = \yii\helpers\Url::to(['kunjungan-asal-masuk/index']);
?>

<div class="row quick-action-toolbar">
    <div class="col-md-12">
        <h2 style="color: #002D72; font-weight: bold; margin-bottom: 20px;">Laporan Jumlah Kunjungan Berdasarkan Asal Masuk Pasien</h2>
        <div class="card border-0 shadow-sm p-3">
            <div class="d-md-flex row m-0 quick-action-btns">
                <?= Html::beginForm(['/eksekutif/kunjungan-asal-masuk/index'], 'get') ?>
...
<?php
$urlExport = \yii\helpers\Url::to(['kunjungan-asal-masuk/export']);
