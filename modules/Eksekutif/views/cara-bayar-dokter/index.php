<?php
    ...
    $this->title = 'Laporan Berdasarkan Dokter';
    ...
    $resetUrl = \yii\helpers\Url::to(['cara-bayar-dokter/index']);
?>

<div class="row quick-action-toolbar">
    <div class="col-md-12">
        <h2 style="color: #002D72; font-weight: bold; margin-bottom: 20px;">Laporan Berdasarkan Dokter</h2>
        <div class="card border-0 shadow-sm p-3">
            <div class="d-md-flex row m-0 quick-action-btns">
                <?= Html::beginForm(['/eksekutif/cara-bayar-dokter/index'], 'get') ?>
...
<?php
$urlExport = \yii\helpers\Url::to(['cara-bayar-dokter/export']);
