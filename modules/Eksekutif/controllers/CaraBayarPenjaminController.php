...
class CaraBayarPenjaminController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Cara Pembayaran Berdasarkan Penjamin');
        $sheet->getStyle('A1')->getFont()->setBold(true)->setSize(18);
        $sheet->getStyle('A2')->getFont()->setBold(true)->setSize(14);

        $sheet->setCellValue('A4', 'No');
        $sheet->setCellValue('B4', 'Instalasi');
        $sheet->setCellValue('C4', 'Cara Bayar');
        $sheet->setCellValue('D4', 'Penjamin');
        ...
        foreach ($models as $model) {
            ...
            $sheet->setCellValue('C' . $row, $model['carabayar_nama']);
            $sheet->setCellValue('D' . $row, $model['penjamin_nama']);
        ...
        $fileName = 'cara-pembayaran-penjamin.xlsx';
