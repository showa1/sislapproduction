...
class HemodialisaController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Kunjungan Hemodialisa Detail');
        ...
        $fileName = 'laporan-hemodialisa-detail.xlsx';
    ...
    {
        $query .= " DATE(tglclosingkasir) between :datefrom and :dateto AND im.instalasi_id = '73' ";
