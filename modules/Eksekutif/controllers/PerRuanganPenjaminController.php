...
class PerRuanganPenjaminController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Per Ruangan Per Penjamin');
        ...
        $sheet->setCellValue('E4', 'Penjamin');
        ...
        foreach ($models as $model) {
            ...
            $sheet->setCellValue('E' . $row, $model['penjamin_nama']);
        ...
        $fileName = 'lap-per-ruangan-penjamin.xlsx';
