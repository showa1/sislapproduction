...
class InapPasienBayarController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Jumlah Kunjungan Rawat Inap Berdasarkan Asal Pasien dan Cara Bayar');
        $sheet->getStyle('A1')->getFont()->setBold(true)->setSize(18);
        $sheet->getStyle('A2')->getFont()->setBold(true)->setSize(14);

        $sheet->setCellValue('A4', 'No');
        $sheet->setCellValue('B4', 'Instalasi Asal');
        $sheet->setCellValue('C4', 'Instalasi Bayar');
        $sheet->setCellValue('D4', 'Kelas Pelayanan');
        $sheet->setCellValue('E4', 'Cara Bayar');
        ...
        foreach ($models as $model) {
            ...
            $sheet->setCellValue('B' . $row, $model['instalasi_asal']);
            $sheet->setCellValue('C' . $row, $model['instalasi_bayar']);
            $sheet->setCellValue('D' . $row, $model['kelaspelayanan_nama']);
            $sheet->setCellValue('E' . $row, $model['carabayar_nama']);
            $sheet->setCellValue('F' . $row, $model['jumlah']);
        ...
        $fileName = 'kunj-asal-pasien-bayar.xlsx';
