...
class PerawatanIntensifController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Kunjungan Perawatan Intensif Detail');
        ...
        $fileName = 'lap-perawatan-intensif.xlsx';
    ...
    {
        $query .= " DATE(tglclosingkasir) between :datefrom and :dateto AND im.instalasi_id = '76' ";
