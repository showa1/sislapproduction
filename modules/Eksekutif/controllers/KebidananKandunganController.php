...
class KebidananKandunganController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Kunjungan Kebidanan Kandungan /VK Detail');
        ...
        $fileName = 'laporan-kandungan-detail.xlsx';
    ...
    {
        $query .= " DATE(tglclosingkasir) between :datefrom and :dateto AND im.instalasi_id = '38' ";
