...
class PembelianObatController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Pembelian Obat Langsung');
        ...
        $fileName = 'pembelian-obat-langsung.xlsx';
    ...
    {
        $query .= " DATE(tglclosingkasir) between :datefrom and :dateto AND im.instalasi_id = '9' ";
