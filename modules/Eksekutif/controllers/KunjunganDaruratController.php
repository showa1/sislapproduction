...
class KunjunganDaruratController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Kunjungan Rawat Darurat Detail');
        ...
        $fileName = 'laporan-rd-detail.xlsx';
    ...
    {
        $query .= " DATE(tglclosingkasir) between :datefrom and :dateto AND im.instalasi_id = '3' ";
