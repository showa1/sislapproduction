...
class KunjunganKelasController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Jumlah Kunjungan Asal Pasien Berdasarkan Kelas');
        ...
        foreach ($models as $model) {
            ...
            $sheet->setCellValue('B' . $row, $model['intalasi_asal']);
        ...
        $fileName = 'kunjungan-by-kelas.xlsx';
