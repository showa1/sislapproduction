...
class PerRuanganCarabayarController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Per Ruangan Per Cara Bayar');
        ...
        $fileName = 'lap-per-ruangan-carabayar.xlsx';
