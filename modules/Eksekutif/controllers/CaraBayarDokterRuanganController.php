...
class CaraBayarDokterRuanganController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Per Dokter Per Ruangan');
        ...
        foreach ($models as $model) {
            ...
            $sheet->setCellValue('D' . $row, $model['ruangan_nama']);
        ...
        $fileName = 'laporan-per-dokter-ruangan.xlsx';
