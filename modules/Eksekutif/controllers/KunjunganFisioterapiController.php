...
class KunjunganFisioterapiController extends BaseController
{    
    ...
    public function actionExport()
    {
        ...
        $sheet->setCellValue('A2', 'Laporan Kunjungan Fisioterapi Detail');
        ...
        $fileName = 'laporan-fisioterapi-detail.xlsx';
    ...
    {
        $query .= " DATE(tglclosingkasir) between :datefrom and :dateto AND im.instalasi_id = '74' ";
